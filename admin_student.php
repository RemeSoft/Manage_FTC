    ...
    <main class="admin">
        ...
        <div class="right">
            ...
            <div class="right__content">
                <div class="right:top">
                    <form class="right:top__input" method="POST" action="./controller/CreateStudent.php" enctype="multipart/form-data">
                        <input class="form__file_input" type="file" name="file">
                        <input class="form__button" name="submit" type="submit" value="Add New Student">
                    </form>
                </div>
                            ...
                            <div class="card__holder">
                                <?php 
                                    ...
                                    <div class="card">
                                        ...
                                        <img class="card__image" src="./img/success/<?=$row['image']?>" alt="">
                                    </div>
                                    <?php
                                    }
                                    } else {
